...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Dragun\DeliveryDate\Model\Shop::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('dragun_deliverydate_shop');
            ...
            $this->dataPersistor->set('dragun_deliverydate_shop', $data);
